...
class AuthToken(Base):
    ...
    __table_args__ = (
        Index("ix_auth_tokens_email_used_expires", "email", "used", "expires_at"),
    )
...
class Attempt(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "puzzle_id"),
        Index("ix_attempts_user_solved", "user_id", "solved"),
        Index("ix_attempts_puzzle_id", "puzzle_id"),
    )
