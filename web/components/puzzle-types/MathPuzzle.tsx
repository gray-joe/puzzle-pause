    ...
    return (
        <>
            <div className="puzzle-box" data-testid="puzzle-question">
                <div
                    style={{ fontSize: '1.2em', letterSpacing: '0.05em' }}
                    dangerouslySetInnerHTML={{ __html: sanitizePuzzleHtml(puzzle.question) }}
                />
            </div>
            {!solved && (
                <form onSubmit={handleSubmit}>
                    <div className="action-btn">
                        ...
                        <input
                            ...
                            value={guess}
                            onChange={(e) => {
                                if (/^-?\d*\.?\d*$/.test(e.target.value)) setGuess(e.target.value);
                            }}
