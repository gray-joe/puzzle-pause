...
export default function ClueRevealPuzzle({ puzzle, solved, onSubmit, loading, hint, hintsRevealed }: Props) {
  ...
  return (
    <>
      <div className="content-meta" data-testid="puzzle-question" style={{ marginBottom: 12, fontSize: "1.2rem", color: "white" }}>{data.prompt}</div>
      <div style={{ marginBottom: 12 }}>
        {allClues.map((clue, i) => (
          <div
            ...
            data-testid={`clue-${i}`}
            style={{ marginBottom: 8, padding: "8px 12px", border: "1px solid var(--border)", borderRadius: 4, color: "white", fontSize: "0.95rem" }}
          >
