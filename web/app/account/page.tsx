            ...
            <table data-testid="stats-table">
                <tbody>
                    <tr>
                        ...
                        <td style={{ textAlign: 'right' }} data-testid="stat-today">
                            {stats.today_score ?? '—'}
                        </td>
                    </tr>
                    <tr>
                        <td className="muted">This week</td>
                        <td style={{ textAlign: 'right' }} data-testid="stat-weekly">
                            {stats.weekly_total}
                        </td>
                    </tr>
                    <tr>
                        <td className="muted">All time</td>
                        <td style={{ textAlign: 'right' }} data-testid="stat-alltime">
                            {stats.alltime_total}
                        </td>
                    </tr>
                    <tr>
                        <td className="muted">Average</td>
                        <td style={{ textAlign: 'right' }} data-testid="stat-average">
                            {stats.average_score.toFixed(0)}
                        </td>
                    </tr>
                    <tr>
                        <td className="muted">Puzzles solved</td>
                        <td style={{ textAlign: 'right' }} data-testid="stat-solved">
                    ...
                    <tr>
                        ...
                        <td
                            style={{
                                textAlign: 'right',
                                color: stats.streak > 0 ? 'var(--teal)' : undefined,
                            }}
