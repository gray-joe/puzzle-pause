...
export default async function AdminAttemptEditPage({
    params,
}: {
    ...
    return (
        <PageShell title="Admin" isAdmin isLoggedIn>
            ...
            <h2>
                <span className="gt">&gt;</span>Edit Attempt #{attempt.id}
            </h2>
            <p className="muted" style={{ marginBottom: 16 }}>
                {attempt.user_display_name ?? attempt.user_email} — {attempt.puzzle_date}{' '}
                {attempt.puzzle_name}
            </p>
