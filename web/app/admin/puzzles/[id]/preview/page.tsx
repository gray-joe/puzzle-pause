...
export default async function AdminPuzzlePreviewPage({ params }: { params: Promise<{ id: string }> }) {
  await requireUser();
  ...
  return (
    <PageShell title="Admin" isAdmin isLoggedIn>
      ...
      <h2><span className="gt">&gt;</span>Preview — {puzzle!.puzzle_name || puzzle!.puzzle_type}</h2>
